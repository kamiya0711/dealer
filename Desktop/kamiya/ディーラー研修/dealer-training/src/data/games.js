...
export const GAMES = [
  ...
  // フェーズ2（準備中）
  { id: 'omaha', name: 'オマハ', category: 'community', phase: 2, available: false },
  ...
  { id: 'razz', name: 'ラズ', category: 'stud', phase: 2, available: false },
  ...
  { id: 'triple_draw_27', name: '2-7トリプルドロー', category: 'draw', phase: 2, available: false },
  { id: 'single_draw_27', name: '2-7シングルドロー', category: 'draw', phase: 2, available: false },
  { id: 'triple_draw_a5', name: 'A-5トリプルドロー', category: 'draw', phase: 2, available: false },
  { id: 'badugi', name: 'バデュギ', category: 'draw', phase: 2, available: false },

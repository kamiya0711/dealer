...
export const GAMES = [
  ...
  { id: 'pineapple',      name: 'パイナップル',           nameEn: 'Pineapple',              category: 'community', phase: 2, available: true },
  { id: 'crazy_pineapple',name: 'クレイジーパイナップル', nameEn: 'Crazy Pineapple',        category: 'community', phase: 2, available: true },
  { id: 'stud',           name: 'セブンカードスタッド',   nameEn: '7-Card Stud',            category: 'stud',      phase: 2, available: true },
  { id: 'stud_hilo',      name: 'スタッドハイロー',       nameEn: 'Stud Hi-Lo',             category: 'stud',      phase: 2, available: true },
  { id: 'razz',           name: 'ラズ',                   nameEn: 'Razz',                   category: 'stud',      phase: 2, available: true },
  { id: 'five_stud',      name: 'ファイブカードスタッド', nameEn: '5-Card Stud',            category: 'stud',      phase: 2, available: true },
  { id: 'five_draw',      name: 'ファイブカードドロー',   nameEn: '5-Card Draw',            category: 'draw',      phase: 2, available: true },
